...
/**
 * Homepage "Featured Products" section. Shows products marked as Featured in
 * the admin panel (Product editor → "Featured", or the Featured page).
 * Simple retail-style cards: image, name, price.
 */
function FeaturedCard({ product }: { product: TProductCard }) {
  return (
    <Link
